...
public class ObjectMapperConfig {
    ...
    @Bean("webJsonJackson2ObjectMapperBuilderCustomizer")
    public Jackson2ObjectMapperBuilderCustomizer jackson2ObjectMapperBuilderCustomizer() {
        return builder -> {
            ...
            builder.featuresToDisable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);//禁用未知属性抛出异常
//            builder.featuresToEnable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES); //启用未知属性抛出异常
