...
import com.github.axinger.service.PaymentService;
...
public class LogDemoController {
    ...
    public Map<String, Object> createOrder(@RequestParam String orderNo,
        ...
        try {
            // 模拟订单处理
            orderService.processOrder(orderNo, productName, amount);
    ...
    public Map<String, Object> processPayment(@RequestParam String payNo,
        ...
        try {
            // 模拟支付处理
            paymentService.processPayment(payNo, orderNo, amount);
